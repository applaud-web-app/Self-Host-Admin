...
<section class="content-body">
    <div class="container-fluid">
        ...
        <form action="{{ url('/notifications/send') }}" method="post" id="notificationform" enctype="multipart/form-data">
            @csrf
            <div class="row">
                    ...
                    <div class="card h-auto">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="ms-2">
                                    <button type="button"
                                            class="btn btn-outline-secondary text-wrap notification"
                                            id="getData">
                        ...
                        <div class="card-body">
                            <div class="row" id="metaForm">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text"
                                           onkeyup="titleText(this)"
                                           class="form-control emoji_picker notification"
                                           name="title"
                                           id="title"
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control emoji_picker notification"
                                              onkeyup="descriptionText(this.value)"
                                              name="description"
                                              id="description"
                                              required
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="userprofile">
                                        ...
                                        <div class="input-group">
                                            <input type="text"
                                                   class="form-control banner_icon_trans"
                                                   name="icons"
                                                   id="target"
                                            ...
                                            <button class="input-group-text d-none"
                                                    type="button"
                                                    style="margin:inherit"
                                                    id="button2-reset"
                                                    onclick="resetIcon()">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 domain-item">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input"
                                               ...
                                               value="domain1.com"
                                               required>
                                        <label class="form-check-label" for="domain-1">domain1.com</label>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12 domain-item">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input"
                                               ...
                                               value="domain2.com"
                                               required>
                                        <label class="form-check-label" for="domain-2">domain2.com</label>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12 domain-item">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input"
                                               ...
                                               value="domain3.com"
                                               required>
                                        <label class="form-check-label" for="domain-3">domain3.com</label>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12 domain-item">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input"
                                               ...
                                               value="domain4.com"
                                               required>
                                        <label class="form-check-label" for="domain-4">domain4.com</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="justify-content-start">
                                <label class="mb-3 me-3 w-auto d-inline-block" for="sendnow">
                                    <input class="radio-option"
                                           type="radio"
                                           name="schedule_type"
                                           id="sendnow"
                                           value="Instant"
                                           onchange="hideorshow(event)"
                                           checked>
                            ...
                            <div class="custom-tab-1" id="schedule_options" style="display: none">
                                ...
                                <div class="tab-content">
                                    <!-- One Time Tab -->
                                    <div class="tab-pane show active fade mb-3 p-3 border"
                                         id="one_time"
                                         role="tabpanel">
                                        ...
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                <div class="form-group">
                                                    <label for="one_time_start_date">Start Date & Time <span class="text-danger">*</span></label>
                                                    <input type="datetime-local"
                                                           class="form-control"
                                                           name="one_time_datetime"
                                                           id="one_time_start_date"
                                                           min="2025-06-02T00:00"
                                                           required>
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                            </div>
                                    ...
                                    <!-- Recurring Tab -->
                                    <div class="tab-pane fade mb-3 p-3 border"
                                         id="recurring"
                                         role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-12 mb-3">
                                                <div class="form-group">
                                                    <label for="recurring_start_date">Start Date <span class="text-danger">*</span></label>
                                                    <input type="date"
                                                           class="form-control"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12 mb-3">
                                                <div class="form-group">
                                                    <div class="d-flex justify-content-between">
                                                        <label for="recurring_end_date">End Date <span class="text-danger">*</span></label>
                                                        <div>
                                                            <input class="form-check-input"
                                                                   type="checkbox"
                                                                   id="end_date"
                                                                   onchange="disableDate()">
                                                            <label class="form-check-label mt-0" for="end_date">Never Ends</label>
                                                        </div>
                                                    </div>
                                                    <input type="date"
                                                           class="form-control"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12 mb-3">
                                                <div class="form-group">
                                                    <label for="occurrence">Repeat <span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12 mb-3">
                                                <div class="form-group">
                                                    <label for="recurring_start_time">Start Time <span class="text-danger">*</span></label>
                                                    <input type="time"
                                                           class="form-control"
                                    ...
                                    <div class="android_body mt-3">
                                        ...
                                        <div class="preview_content d-flex justify-content-between align-items-center">
                                            <div class="flex-grow-1">
                                                <span class="fs-16 text-black prv_title" id="prv_title">Title Preview</span>
                                                <p class="card-text fs-14 prv_desc" id="prv_desc">Preview of Description</p>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('images/push/icons/alarm-1.png') }}" id="icon_prv" class="img-fluid" alt="Icon Preview">
                                            </div>
            ...
            <div class="mt-3">
                <button type="submit"
                        id="sendNotification"
                        class="btn btn-primary send_btn mb-2">
                    <i class="far fa-check-square pe-2"></i>Send Now
                </button>
                <button type="reset"
                        class="btn basic-btn mb-2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-wrap">
                ...
                @foreach ($files as $file)
                    ...
                    @endphp
                    <div class="m-1">
                        <img src="{{ asset('images/push/icons/' . $filename) }}"
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Get Data button: static placeholder
        $("#getData").click(function() {
            let url = $("#target_url").val().trim();
            if (!url) {
                iziToast.error({
                    title: "Warning!",
                    message: "Please fill the target URL first!",
                    position: "topRight",
                });
                return;
            }
            iziToast.info({
                title: "Info",
                message: "Metadata fetching is not configured in this static example.",
                position: "topRight",
            });
        });
    });
