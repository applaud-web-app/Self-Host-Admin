...
<section class="content-body">
    <div class="container-fluid">
        <div class="d-flex flex-wrap align-items-center text-head">
            <h2 class="mb-3 me-auto">Add Coupon</h2>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form id="addCouponForm" action="{{route('admin.coupons.store')}}" method="POST" autocomplete="off">
                            @csrf
                            <div class="row">
                                <!-- Coupon Code -->
                                <div class="col-lg-6 col-md-6 col-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <input type="text" class="form-control rounded-0 text-uppercase" name="code" id="code" placeholder="Enter coupon code" required>
                                            <button class="btn btn-primary rounded-0" value="{{old('code')}}" id="genrateCode" type="button"><i class="fas fa-sync"></i></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="discount_amount" id="discount_amount" placeholder="Enter discount amount" min="1" step="1" required>
                                    </div>
                                </div>
                                ...
                                <!-- Usage Limit -->
                                <div class="col-lg-6 col-md-6 col-12 mb-3 d-none" id="usageLimit">
                                    <div class="form-group">
                                        <label for="usage_limit">Usage Limit <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="usage_limit" id="usage_limit" placeholder="Enter usage limit" min="2" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"  maxlength="225" name="description" id="description" placeholder="Enter short description" style="height: 100px" required></textarea>
                                    </div>
                                </div>
