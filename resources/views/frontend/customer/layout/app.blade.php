                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="{{route('customer.profile.show')}}" class="dropdown-item ai-icon">
                                        <i class="far fa-user text-primary"></i>
                                        <span class="ms-1">Profile</span>
                                    </a>
                                    <a href="{{route('customer.logout')}}" class="dropdown-item ai-icon text-danger">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    <!-- Dashboard -->
                    <li>
                        <a class="ai-icon" href="{{ route('customer.dashboard') }}" aria-expanded="false">
                    ...
                    <!-- Profile -->
                    {{-- <li>
                        <a class="ai-icon" href="{{ route('customer.profile.show') }}" aria-expanded="false">
                    ...
                    <!-- Payment -->
                    <li>
                        <a class="ai-icon" href="{{ route('customer.payment.show') }}" aria-expanded="false">
                    ...
                    <li>
                        <a class="ai-icon" href="{{ route('customer.addons.show') }}" aria-expanded="false">
                    ...
                    <!-- Logout -->
                    <li>
                        <a class="ai-icon" href="{{ route('customer.logout') }}" aria-expanded="false">
