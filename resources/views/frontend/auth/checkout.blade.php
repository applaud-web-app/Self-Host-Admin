...
.error-text   { color:#e53e3e; font-size:.9rem;  }
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <textarea name="address" id="address" cols="30" rows="4" class="form-control"
                                          placeholder="Indi Road" required>{{ old('address') }}</textarea>
    ...
    $('#checkout-form').validate({
        ...
        rules: {
            ...
            email:  {
                ...
                remote:{url:"{{ route('checkout.checkEmail') }}",type:"post",
        ...
        messages:{
            ...
            phone:{remote:'This phone is already taken.'},
