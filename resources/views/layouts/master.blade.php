...
<body>
   ...
   <ul class="metismenu" id="menu">
    ...
    <!-- Domains -->
    <li>
        <a class="ai-icon" href="{{ route('domain') }}" aria-expanded="false">
    ...
    <li>
        ...
        <ul aria-expanded="false">
            <li><a href="{{ route('send-notification') }}">Send Notification</a></li>
            <li><a href="{{ route('campaign-reports') }}">Reports</a></li>
        </ul>
    </li>
    ...
    <!-- Support -->
    <li>
        <a href="{{ url('/support') }}" class="ai-icon" aria-expanded="false">
